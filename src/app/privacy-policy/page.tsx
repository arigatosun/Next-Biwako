      ...
      <Container maxWidth="md" sx={{ py: 8, flex: 1 }}>
        ...
        >
          ...
          <Typography variant="body1" paragraph>
            NEST琵琶湖（以下「当社」といいます）は、本ウェブサイト（以下「本サイト」といいます）を通じて提供するサービスにおいて、利用者の個人情報の保護を最優先に考えています。本プライバシーポリシー（以下「本ポリシー」といいます）は、当社がどのようにして個人情報を収集、使用、保護し、利用者の権利を尊重するかについて定めたものです。
          </Typography>
            ...
            <PolicySection
              ...
              content={
                <>
                  ...
                  NEST琵琶湖株式会社<br />
                  〒520-1836 滋賀県高島市マキノ町新保浜田146-1<br />
