// app/components/ReservationCompletionContent.tsx
'use client';
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-4 sm:p-8">
              ...
              <div className="text-center mb-6 sm:mb-8">
                ...
                <p className="text-sm sm:text-base text-[#363331]">
                  メールが届かない場合は<a href="#" className="text-blue-500 underline">こちら</a>をご確認ください。
                </p>
              </div>

              <div className="mb-6 sm:mb-8">
                <p className="text-xs sm:text-sm text-[#363331] mb-1 sm:mb-2">
                  以下の「予約番号」は予約内容の確認・変更・キャンセルに必要です。
                </p>
